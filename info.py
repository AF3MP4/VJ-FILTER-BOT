...
API_ID = int(environ.get('API_ID', '21916553'))
API_HASH = environ.get('API_HASH', 'b5d5a4475781d50224ff3b959fa9ec22')
BOT_TOKEN = environ.get('BOT_TOKEN', "")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/ITh.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1299019258 6555824290').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002611275218'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002586981469').split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://aflahk80:Db2XU1PPfeRYiE29@cluster0.wd94w.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "aflahk80")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/AF_KINGbot')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/AF_KINGbot')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'AF_KINGbot') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/AF_KINGbot')
